...
export interface Getters {
    eventProp: (event: CalendarEvent, start: any, end: any, isSelected: boolean) => any;
    backgroundEventProp: (event: CalendarEvent, start: any, end: any, isSelected: boolean) => any;
...
export type ViewNames = string[] | {
    [view: string]: any;
};
export type DayLayoutAlgorithm = 'overlap' | 'no-overlap' | ((...args: any[]) => any);
