...
import { merge, inRange, lt, lte, gt, gte, eq, neq, startOf, endOf, add, range, diff, duration, ceil, min, max, firstVisibleDay, lastVisibleDay, visibleDays, minutes, isJustDate, } from './utils/dates';
...
export function mergeWithDefaults(localizer, culture, formatOverrides, messages) {
    ...
    return {
        ...
        format: (value, format) => localizer.format(value, formats[format] || format, culture),
    };
}
