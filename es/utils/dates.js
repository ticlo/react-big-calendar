...
export function visibleDays(date, localizer) {
    let current = firstVisibleDay(date, localizer), last = lastVisibleDay(date, localizer), days = [];
...
export function diff(dateA, dateB, unit) {
    ...
    return Math.round(Math.abs(+dates.startOf(dateA, unit) / MILLI[unit] -
