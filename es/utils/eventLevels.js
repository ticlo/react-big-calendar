...
export function sortWeekEvents(events, accessors, localizer) {
    ...
    const multiSorted = multiDayEvents.sort((a, b) => sortEvents(a, b, accessors, localizer));
    const standardSorted = standardEvents.sort((a, b) => sortEvents(a, b, accessors, localizer));
